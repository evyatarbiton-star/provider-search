...
export function Experiment5() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG_WHITE }}>
      ...
      {showSidebar && <div data-testid="filter-bar" style={{
        borderBottom: `1px solid ${BORDER_LIGHT}`,
        background: BG_WHITE,
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: SPACE_XS }}>
            <Select
              ...
              renderTrigger={(selected) => {
                ...
                if (!opt) return <span style={{ flex: 1, color: TEXT_LIGHT, fontFamily: FONT, fontSize: fontSizes[14] }}>Select plan</span>
                return (
