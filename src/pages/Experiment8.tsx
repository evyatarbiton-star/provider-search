...
const PROVIDERS_COPAY_FLAT = [
  { name: 'Dr. Emily Park', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.3 miles', address: '161 Madison Ave, New York, NY', rating: 4.6, reviewCount: 245, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Today, May 7' },
  { name: 'Dr. James Rodriguez', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.8 miles', address: '30 E 40th St, New York, NY', rating: 4.2, reviewCount: 178, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Tomorrow, May 8' },
  { name: 'Dr. Priya Sharma', specialty: 'Optometrist', providerType: 'female' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.5 miles', address: '457 Broome St, New York, NY', rating: 4.8, reviewCount: 412, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Thu, May 9' },
  { name: 'Dr. Omar Hassan', specialty: 'Dermatologist', providerType: 'male' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.5 miles', address: '425 W 59th St, New York, NY', rating: 3.9, reviewCount: 89, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Mon, May 12' },
  { name: 'Dr. Benjamin Lee', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '2.1 miles', address: '635 Madison Ave, New York, NY', rating: 4.5, reviewCount: 156, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Wed, May 14' },
]
  ...
  return (
    <div style={{
      ...
      <button onClick={() => map.zoomIn()} style={{
        width: 36, height: 36, background: 'white', border: `1px solid #e0e0e0`,
...
export function Experiment8() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG_WHITE }}>
      ...
      <div style={{
        ...
        {showSidebar ? (
          ...
          <div
            ...
            padding: 4,
            border: `1px solid ${activeSegment ? TEXT_DEFAULT : BORDER_STRONG}`,
            borderRadius: RADIUS_FULL,
            overflow: 'visible',
            boxShadow: activeSegment ? '0 4px 16px rgba(0,0,0,0.12)' : 'none',
            ...
            <div
              ...
              style={{
                ...
                background: activeSegment === 'service' ? BG_SUBTLE : hoveredSegment === 'service' ? '#f5f5f5' : 'transparent',
                borderRadius: RADIUS_FULL,
            ...
            >
              ...
              {activeSegment === 'service' ? (
                ...
                <div style={{ fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[14], color: searchQuery ? TEXT_DEFAULT : TEXT_LIGHT, lineHeight: '18px' }}>
              ...
              {activeSegment === 'service' && (
                <div style={{
                  ...
                  boxShadow: '0 8px 24px rgba(0,0,0,0.12)', padding: SPACE_XS, minWidth: 280, zIndex: 9000,
                }}>
                  <p style={{ fontFamily: FONT, fontWeight: W_MEDIUM, fontSize: fontSizes[12], color: TEXT_LIGHT, margin: `0 0 ${SPACE_XXS}px`, padding: `0 ${SPACE_XXS}px` }}>Recent searches</p>
                  {['Retinal imaging', 'Dr. Sarah Chen', 'Dermatology', 'Physical therapy', 'Mount Sinai Hospital'].map(s => (
                    <div key={s} onClick={() => { setSearchQuery(s); setActiveSegment(null) }} style={{
                      padding: `${SPACE_XXS}px ${SPACE_XXS}px`, cursor: 'pointer', borderRadius: 6,
                      fontFamily: FONT, fontSize: fontSizes[14], color: TEXT_DEFAULT,
                      background: searchQuery === s ? sc.primary.surface.subtle : 'transparent',
                    }}>
                      {s}
                    </div>
                  ))}
            ...
            <div
              ...
              style={{
                ...
                cursor: 'pointer', position: 'relative',
                background: activeSegment === 'plan' ? BG_SUBTLE : hoveredSegment === 'plan' ? '#f5f5f5' : 'transparent',
                borderRadius: RADIUS_FULL,
                transition: 'background 0.15s',
              }}
            >
            ...
            <div
              ...
              style={{
                flex: 1, padding: `${SPACE_XXS}px ${SPACE_M}px`,
                cursor: 'pointer', position: 'relative',
                background: activeSegment === 'network' ? BG_SUBTLE : hoveredSegment === 'network' ? '#f5f5f5' : 'transparent',
                borderRadius: RADIUS_FULL,
                transition: 'background 0.15s',
              }}
            >
            ...
            <div
              ...
              style={{
                flex: 1, padding: `${SPACE_XXS}px ${SPACE_M}px`,
                cursor: 'pointer', position: 'relative',
                background: activeSegment === 'location' ? BG_SUBTLE : hoveredSegment === 'location' ? '#f5f5f5' : 'transparent',
                borderRadius: RADIUS_FULL,
                transition: 'background 0.15s',
              }}
            >
      ...
      {/* ── Filter Bar (horizontal, below search — desktop only) ── */}
      ...
      <div style={{
        maxWidth: 1280, margin: '0 auto',
        display: 'flex', flexDirection: 'row', gap: 72,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            <h2 style={{
              fontFamily: FONT, fontWeight: W_REGULAR,
              fontSize: showSidebar ? fontSizes[24] : fontSizes[18],
              lineHeight: showSidebar ? '33px' : '24px',
