...
const PROVIDERS_CONNECTED = [
  {
    ...
    photoUrl: 'https://images.unsplash.com/photo-1594824476967-48c8b964dc31?w=200&h=200&fit=crop&crop=face',
...
const PROVIDERS_COPAY_FLAT = [
  { name: 'Dr. Aisha Patel', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1594824476967-48c8b964dc31?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.3 miles', address: '110 E 59th St, New York, NY', rating: 4.6, reviewCount: 320, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Today, May 7' },
  { name: 'Dr. David Kim', specialty: 'Optometrist', photoUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.8 miles', address: '51 W 51st St, New York, NY', rating: 4.5, reviewCount: 245, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Tomorrow, May 8' },
  { name: 'Dr. Benjamin Lee', specialty: 'Dermatologist', providerType: 'male' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.5 miles', address: '161 Madison Ave, New York, NY', rating: 4.8, reviewCount: 412, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Thu, May 9' },
  { name: 'Dr. Sarah Chen', specialty: 'Dermatologist', providerType: 'female' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.2 miles', address: '425 W 59th St, New York, NY', rating: 4.2, reviewCount: 178, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Mon, May 12' },
  { name: 'Dr. James Rodriguez', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.5 miles', address: '635 Madison Ave, New York, NY', rating: 3.9, reviewCount: 89, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Wed, May 14' },
]

// Fully covered — all $0
const PROVIDERS_ZERO_COST = [
  { name: 'Dr. Aisha Patel', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1594824476967-48c8b964dc31?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.3 miles', address: '110 E 59th St, New York, NY', rating: 4.6, reviewCount: 320, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Today, May 7' },
  { name: 'Dr. David Kim', specialty: 'Optometrist', photoUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.8 miles', address: '51 W 51st St, New York, NY', rating: 4.5, reviewCount: 245, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Tomorrow, May 8' },
  { name: 'Dr. Benjamin Lee', specialty: 'Dermatologist', providerType: 'male' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.5 miles', address: '161 Madison Ave, New York, NY', rating: 4.8, reviewCount: 412, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Thu, May 9' },
  { name: 'Dr. Sarah Chen', specialty: 'Dermatologist', providerType: 'female' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.2 miles', address: '425 W 59th St, New York, NY', rating: 4.2, reviewCount: 178, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Mon, May 12' },
]
...
const PROVIDERS_SERVICE_PRICE = [
  servicePriceProvider('Dr. Aisha Patel', 'https://images.unsplash.com/photo-1594824476967-48c8b964dc31?w=200&h=200&fit=crop&crop=face'),
  servicePriceProvider('Dr. David Kim', 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=200&h=200&fit=crop&crop=face'),
  servicePriceProvider('Dr. Benjamin Lee', undefined, 'male'),
  servicePriceProvider('Dr. Sarah Chen', undefined, 'female'),
...
const PROVIDERS_NOT_CONNECTED = [
  notConnectedProvider('Dr. Lisa Wang', 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=200&h=200&fit=crop&crop=face'),
  notConnectedProvider('Dr. Christopher Montgo Vander', 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=200&h=200&fit=crop&crop=face'),
  notConnectedProvider('Dr. Priya Sharma', 'https://images.unsplash.com/photo-1594824476967-48c8b964dc31?w=200&h=200&fit=crop&crop=face'),
  notConnectedProvider('Dr. Omar Hassan', 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=200&h=200&fit=crop&crop=face'),
]
...
// ── Map Placeholder ───────────────────────────────────────────
const MAP_IMG = 'https://basemaps.cartocdn.com/light_all/14/4825/6156@2x.png'
...
// ── Cost Box (above map) ─────────────────────────────────────
function CostBox({ scenario, onLearnMore, onConnect, headerSlot }: { scenario: ScenarioConfig; onLearnMore?: () => void; onConnect?: () => void; headerSlot?: React.ReactNode }) {
      ...
      <div style={cardStyle}>
        ...
        <div style={sectionStyle}>
          <p style={{
            ...
            Connect your deductible status to see exact prices
          </p>
          <p style={{
            fontFamily: FONT, fontWeight: W_REGULAR,
            fontSize: fontSizes[14], lineHeight: '20px', color: TEXT_DARK, margin: `${SPACE_XXS}px 0 0`,
          }}>
            {cb.connectSubtitle}
          </p>
        </div>
        ...
        {/* Coverage info boxes */}
        <div style={sectionStyle}>
          <p style={sectionTitle}>Your coverage</p>
          <div style={{
            ...
            <div style={{ padding: `4px ${SPACE_XS}px`, display: 'flex', flexDirection: 'column', gap: 4 }}>
              <p style={{ fontFamily: FONT, fontWeight: W_MEDIUM, fontSize: fontSizes[14], color: TEXT_DEFAULT, margin: 0 }}>
                Coverage (Before deductible)
              </p>
              <p style={{ fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[14], color: TEXT_DARK, margin: 0 }}>
                You'll pay 40% from what provider charge
              </p>
            </div>
  ...
  // EXPANDED: All modal info shown inline
  return (
    <div style={cardStyle}>

      {/* ── Header slot (Plan & Network selects) ── */}
      {headerSlot}

      {/* ── Section 1: Your estimated cost ── */}
      <div style={sectionStyle}>
        <p style={{
          fontFamily: FONT_DISPLAY, fontWeight: W_MEDIUM,
          fontSize: fontSizes[24], lineHeight: '29px', color: TEXT_DEFAULT, margin: 0,
        ...
        <p style={{
          fontFamily: FONT, fontWeight: W_REGULAR,
          fontSize: fontSizes[14], lineHeight: '17px', color: TEXT_DARK, margin: `${SPACE_XXS}px 0 0`,
        }}>
          {cb.subtitle}
        </p>

        {/* Chart */}
        <div style={{ marginTop: SPACE_S, display: 'flex', flexDirection: 'column', gap: SPACE_XS }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[14], color: TEXT_DARK }}>{cb.rangeLow}</span>
            <span style={{ fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[14], color: TEXT_DARK }}>{cb.rangeHigh}</span>
          </div>
        </div>
      </div>
      ...
      {modal && (
        <>
          ...
          {/* ── Section 2: Your plan & coverage ── */}
          <div style={sectionStyle}>
            <p style={sectionTitle}>Your plan & coverage</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
              {[
                { label: 'Plan', value: modal.plan },
                { label: 'Network', value: modal.network },
                ...modal.coverageRows.filter(r => r.label !== 'Plan' && r.label !== 'Network'),
              ].map((row, i, arr) => (
                <div key={row.label}>
                  <div style={{
                    ...
                    <span style={{
                      ...
                      {'hasCheck' in row && row.hasCheck && <CheckCrFrLine size="sm" color={SUCCESS_TEXT} />}
                      {row.value}
                    </span>
                  </div>
          ...
          {/* ── Section 3: How the cost is calculated ── */}
          <div style={sectionStyle}>
            <p style={sectionTitle}>How we calculated this</p>
            <p style={{
              fontFamily: FONT, fontWeight: W_REGULAR,
              fontSize: fontSizes[14], lineHeight: '20px', color: TEXT_DARK, margin: 0,
            }}>
              {modal.explanation}
            </p>

            {/* Before / After insurance mini cards */}
            {modal.beforeInsurance && (
              <div style={{ marginTop: SPACE_S, display: 'flex', flexDirection: 'column', gap: SPACE_XXS }}>
                <div style={{
                  background: sc.neutral.surface.extraSubtle, borderRadius: RADIUS_XXS,
                  padding: `${SPACE_XS}px ${SPACE_S}px`,
                }}>
                  <span style={{ fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[12], color: TEXT_LIGHT }}>Before insurance</span>
                  <p style={{ fontFamily: FONT_DISPLAY, fontWeight: W_MEDIUM, fontSize: fontSizes[18], color: TEXT_DEFAULT, margin: '2px 0 0' }}>
                    {modal.beforeInsurance}
                  </p>
                </div>
                <div style={{
                  ...
                  <span style={{ fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[12], color: TEXT_LIGHT }}>After insurance</span>
                  <p style={{ fontFamily: FONT_DISPLAY, fontWeight: W_MEDIUM, fontSize: fontSizes[18], color: BLUE_500, margin: '2px 0 0' }}>
                    {modal.afterInsurance}
                  </p>
                  {modal.costPercent && (
                    <span style={{ fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[12], color: TEXT_DARK }}>
                      Your out of pocket cost ({modal.costPercent})
                    </span>
                  )}
                </div>
              </div>
          ...
          <div style={{ ...sectionStyle, paddingTop: 0 }}>
            <p style={{
              fontFamily: FONT, fontWeight: W_REGULAR,
              fontSize: fontSizes[12], lineHeight: '16px', color: TEXT_LIGHT, margin: 0,
            }}>
              This is an estimate based on typical provider charges and your plan's cost-sharing. Your actual cost may vary.
            </p>
          </div>
        </>
      )}
...
// ── Experiment 3 Scenario Switcher FAB ──────────────────────
const EXP3_SCENARIOS: { id: ScenarioId; label: string; description: string }[] = [
  { id: 'coinsurance-range', label: 'Connected', description: 'User connected, coinsurance with range' },
  { id: 'not-connected', label: 'Not connected', description: 'User not connected to deductible' },
]

function Exp3ScenarioSwitcher({ current, onChange }: { current: ScenarioId; onChange: (id: ScenarioId) => void }) {
  const [open, setOpen] = useState(false)
  return (
    <div style={{ position: 'fixed', bottom: 36, left: SPACE_S, zIndex: 1999 }}>
      {open && (
        <div style={{
          position: 'absolute', bottom: 56, left: 0,
          background: BG_WHITE, borderRadius: RADIUS_XS,
      ...
      <button
        onClick={() => setOpen(!open)}
        style={{
          width: 48, height: 48, borderRadius: parseInt(semanticRadii.full),
          background: TEXT_DEFAULT, border: 'none', cursor: 'pointer',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          boxShadow: '0 4px 12px rgba(0,0,0,0.25)',
        }}
...
export function Experiment3() {
  const [scenarioId, setScenarioId] = useState<ScenarioId>('not-connected')
  ...
  const handleConnect = () => {
    ...
    setIsLoading(true)
    setTimeout(() => {
      setScenarioId('coinsurance-range')
      setIsLoading(false)
    }, 2500)
  }
  ...
  const [openPlanDrop, setOpenPlanDrop] = useState(false)
  const [openNetworkDrop, setOpenNetworkDrop] = useState(false)
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG_WHITE }}>
      ...
      <div style={{
        ...
        {showSidebar ? (
          ...
          <div style={{
            ...
            overflow: 'hidden',
            background: BG_WHITE,
            padding: `4px 4px 4px ${SPACE_S}px`,
          }}>
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: SPACE_XXS }}>
              <SearchLine size="sm" color={TEXT_LIGHT} />
              <input
                value={searchQuery}
            ...
            <div style={{ width: 1, height: 32, background: BORDER_STRONG, margin: `0 ${SPACE_XXS}px` }} />
            <div style={{ display: 'flex', alignItems: 'center', gap: SPACE_XXS, padding: `0 ${SPACE_S}px`, minWidth: 200 }}>
              <HomeLine size="sm" color={TEXT_DEFAULT} />
            ...
            <Button variant="primary" size="sm" iconOnly aria-label="Search"
              style={{ borderRadius: RADIUS_FULL, width: 40, height: 40 }}>
              <SearchLine size="sm" color={BG_WHITE} />
            </Button>
          </div>
          </div>
        ) : (
      ...
      <div data-testid="filter-bar" style={{
        ...
        <div style={{
          maxWidth: 1280, margin: '0 auto',
          padding: `${SPACE_XS}px ${showSidebar ? SPACE_XL : SPACE_S}px`,
          ...
          {/* ── Distance ── */}
          <FilterPopover
            label={distanceOptions.find(o => o.value === distance)?.label || 'Distance'}
            active={distance !== '5'}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: SPACE_XXS }}>
              {distanceOptions.map((opt) => (
                <label key={opt.value} style={{
                  display: 'flex', alignItems: 'center', gap: SPACE_XXS, cursor: 'pointer',
                  padding: `${SPACE_XXS}px 0`,
                }}>
                  <RadioButton
          ...
          {/* ── Rating ── */}
          <FilterPopover
            label={rating !== '5' ? `Rating ${rating}★+` : 'Rating'}
            active={rating !== '5'}
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
              {[5, 4, 3, 2, 1].map((stars) => (
                <div key={stars} style={{
                  display: 'flex', alignItems: 'center', gap: SPACE_XXS,
                  padding: `${SPACE_XXS}px 0`, cursor: 'pointer',
                }}>
                  <RadioButton
                    name="rating-filter"
          ...
          <FilterPopover
            label={
              genderSelection.male && genderSelection.female ? 'Male, Female'
              : genderSelection.male ? 'Male'
              : genderSelection.female ? 'Female'
              : 'Gender'
            }
            active={genderSelection.male || genderSelection.female}
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: SPACE_XS }}>
              <Checkbox
                ...
                onChange={(checked) => setGenderSelection(prev => ({ ...prev, male: checked }))}
                label="Male"
              />
              <Checkbox
                checked={genderSelection.female}
                onChange={(checked) => setGenderSelection(prev => ({ ...prev, female: checked }))}
                label="Female"
              />
            </div>
          </FilterPopover>
          ...
          {/* ── Language ── */}
          <FilterPopover
            label={languages.length > 0 ? `Language (${languages.length})` : 'Language'}
            active={languages.length > 0}
            open={openFilter === 'language'}
            onToggle={() => toggleFilter('language')}
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: SPACE_XS, maxHeight: 240, overflowY: 'auto' }}>
              {languageOptions.map((opt) => (
                <Checkbox
                  key={opt.value}
                  checked={languages.includes(opt.value)}
                  onChange={(checked) => {
                    if (checked) setLanguages([...languages, opt.value])
                    else setLanguages(languages.filter(l => l !== opt.value))
                  }}
                  label={opt.label}
                />
              ))}
          ...
          <div style={{ display: 'flex', alignItems: 'center', flexShrink: 0, borderRadius: RADIUS_FULL, outline: onlineBooking ? `2px solid ${TEXT_DEFAULT}` : 'none' }}>
            <Button
              variant="outline"
              size="xs"
              pill
            ...
            >
              <span style={{ display: 'flex', alignItems: 'center', gap: SPACE_XXS }}>
                <Checkbox
          ...
          {/* Divider */}
          <div style={{ width: 1, height: 24, background: BORDER_STRONG, flexShrink: 0, margin: `0 ${SPACE_XXS}px` }} />

          <Button
            variant="outline"
            size="xs"
            pill
            iconLeft={<FilterLine size="sm" />}
          >
            All filters
          </Button>

          {/* Reset link */}
          {(distance !== '5' || rating !== '5' || genderSelection.male || genderSelection.female || languages.length > 0) && (
            <button
              onClick={() => {
                setDistance('5'); setRating('5')
                setGenderSelection({ male: false, female: false })
                setLanguages([])
                setOpenFilter(null)
              }}
              style={{
                background: 'none', border: 'none', cursor: 'pointer', padding: `0 ${SPACE_XXS}px`,
                fontFamily: FONT, fontWeight: W_MEDIUM, fontSize: fontSizes[14],
                color: TEXT_LIGHT, whiteSpace: 'nowrap', flexShrink: 0,
              }}
            >
              Reset
            </button>
      ...
      <div style={{
              ...
              headerSlot={
                <div style={{
                  ...
                  <div style={{
                    ...
                    {/* Plan trigger */}
                    <button
                      onClick={() => { setOpenPlanDrop(p => !p); setOpenNetworkDrop(false) }}
                      style={{
                        flex: 1, height: '100%', display: 'flex', alignItems: 'center',
                        justifyContent: 'space-between', padding: `0 ${SPACE_XS}px`,
                        background: 'none', border: 'none', cursor: 'pointer',
                        fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[14], color: TEXT_DEFAULT,
                      }}
                    >
                      <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {planOptions.find(o => o.value === plan)?.label || 'Plan'}
                      </span>
                      <ChevronDownLine size="sm" color={TEXT_DARK} />
                    </button>

                    {/* Divider */}
                    <div style={{ width: 1, height: 24, background: BORDER_STRONG, flexShrink: 0 }} />

                    {/* Network trigger */}
                    <button
                      onClick={() => { setOpenNetworkDrop(p => !p); setOpenPlanDrop(false) }}
                      style={{
                        flex: 1, height: '100%', display: 'flex', alignItems: 'center',
                        justifyContent: 'space-between', padding: `0 ${SPACE_XS}px`,
                        background: 'none', border: 'none', cursor: 'pointer',
                    ...
                    >
                      <span style={{ display: 'flex', alignItems: 'center', gap: SPACE_XXS, overflow: 'hidden', whiteSpace: 'nowrap' }}>
                        {networkOptions.find(o => o.value === network)?.iconLeft}
                        {networkOptions.find(o => o.value === network)?.label || 'Network'}
                      </span>
                      <ChevronDownLine size="sm" color={TEXT_DARK} />
                    </button>
                  </div>
                  ...
                  {openPlanDrop && (
                    <div style={{
                      ...
                      background: BG_WHITE, borderRadius: RADIUS_XXS,
                      border: `1px solid ${BORDER_STRONG}`,
                      boxShadow: '0 8px 24px rgba(0,0,0,0.12)',
                      padding: `${SPACE_XXS}px 0`, zIndex: 200,
                      minWidth: 220,
                    }}>
                      {planOptions.map(opt => (
                        <div
                          key={opt.value}
                          onClick={() => { setPlan(opt.value); setOpenPlanDrop(false) }}
                          style={{
                            padding: `${SPACE_XS}px ${SPACE_S}px`, cursor: 'pointer',
                            fontFamily: FONT, fontSize: fontSizes[14], color: TEXT_DEFAULT,
                            fontWeight: plan === opt.value ? W_MEDIUM : W_REGULAR,
                            background: plan === opt.value ? sc.neutral.surface.extraSubtle : 'transparent',
                          }}
                          onMouseEnter={(e) => { if (plan !== opt.value) (e.target as HTMLDivElement).style.background = sc.neutral.surface.extraSubtle }}
                          onMouseLeave={(e) => { if (plan !== opt.value) (e.target as HTMLDivElement).style.background = 'transparent' }}
                        >
                          {opt.label}
                        </div>
                      ))}
                  ...
                  {openNetworkDrop && (
                    <div style={{
                      ...
                      {networkOptions.map(opt => (
                        <div
                          key={opt.value}
                          onClick={() => { setNetwork(opt.value); setOpenNetworkDrop(false) }}
                          style={{
                            padding: `${SPACE_XS}px ${SPACE_S}px`, cursor: 'pointer',
                            fontFamily: FONT, fontSize: fontSizes[14], color: TEXT_DEFAULT,
                            fontWeight: network === opt.value ? W_MEDIUM : W_REGULAR,
                            background: network === opt.value ? sc.neutral.surface.extraSubtle : 'transparent',
                            display: 'flex', alignItems: 'center', gap: SPACE_XXS,
                          }}
                          onMouseEnter={(e) => { if (network !== opt.value) (e.currentTarget as HTMLDivElement).style.background = sc.neutral.surface.extraSubtle }}
                          onMouseLeave={(e) => { if (network !== opt.value) (e.currentTarget as HTMLDivElement).style.background = 'transparent' }}
                        >
                          {opt.iconLeft}
                          {opt.label}
                        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {/* Mobile: CostBox + action buttons */}
          {!showSidebar && (
            <div style={{ marginBottom: SPACE_S }}>
              <div style={{
                display: 'grid', gridTemplateColumns: '1fr 1fr', gap: SPACE_XS,
                marginBottom: SPACE_S,
              }}>
                <Button variant="outline" size="md" fullWidth iconLeft={<MapLine size="md" />}>
                  Map view
                </Button>
                <Button variant="outline" size="md" fullWidth iconLeft={<FilterLine size="md" />}>
                  All filters
                </Button>
              </div>
              {isLoading ? <CostBoxSkeleton /> : <CostBox scenario={scenario} onLearnMore={() => setShowCostModal(true)} onConnect={() => setShowConnectModal(true)} />}
            </div>
          )}

          {/* Title + Sort in same row */}
          <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            marginBottom: SPACE_L,
          }}>
            <h2 style={{
              fontFamily: FONT, fontWeight: W_REGULAR, fontSize: fontSizes[24],
      ...
      {/* ── Scenario Switcher FAB ── */}
      <Exp3ScenarioSwitcher current={scenarioId} onChange={setScenarioId} />
    </div>
  )
}
