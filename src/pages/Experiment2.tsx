...
const PROVIDERS_COPAY_FLAT = [
  { name: 'Dr. Rachel Goldstein', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.5 miles', address: '1250 Broadway, New York, NY', rating: 4.5, reviewCount: 156, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Tomorrow, May 8' },
  { name: 'Dr. Omar Hassan', specialty: 'Ophthalmologist', photoUrl: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.3 miles', address: '457 Broome St, New York, NY', rating: 4.8, reviewCount: 412, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Today, May 7' },
  { name: 'Dr. Lisa Wang', specialty: 'Dermatologist', providerType: 'female' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.2 miles', address: '635 Madison Ave, New York, NY', rating: 4.1, reviewCount: 89, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Thu, May 9' },
  { name: 'Dr. Christopher Montgo Vander', specialty: 'Dermatologist', providerType: 'male' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.8 miles', address: '30 E 40th St, New York, NY', rating: 4.2, reviewCount: 245, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Mon, May 12' },
  { name: 'Dr. Priya Sharma', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1594824476967-48c8b964dc31?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.5 miles', address: '51 W 51st St, New York, NY', rating: 3.9, reviewCount: 178, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Wed, May 14' },
]

// Fully covered — all $0
const PROVIDERS_ZERO_COST = [
  { name: 'Dr. Rachel Goldstein', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.5 miles', address: '1250 Broadway, New York, NY', rating: 4.5, reviewCount: 156, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Tomorrow, May 8' },
  { name: 'Dr. Omar Hassan', specialty: 'Ophthalmologist', photoUrl: 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.3 miles', address: '457 Broome St, New York, NY', rating: 4.8, reviewCount: 412, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Today, May 7' },
  { name: 'Dr. Lisa Wang', specialty: 'Dermatologist', providerType: 'female' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.2 miles', address: '635 Madison Ave, New York, NY', rating: 4.1, reviewCount: 89, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Thu, May 9' },
  { name: 'Dr. Christopher Montgo Vander', specialty: 'Dermatologist', providerType: 'male' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.8 miles', address: '30 E 40th St, New York, NY', rating: 4.2, reviewCount: 245, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Mon, May 12' },
]
...
const PROVIDERS_SERVICE_PRICE = [
  servicePriceProvider('Dr. Rachel Goldstein', 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=200&h=200&fit=crop&crop=face'),
  servicePriceProvider('Dr. Omar Hassan', 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=200&h=200&fit=crop&crop=face'),
  servicePriceProvider('Dr. Lisa Wang', undefined, 'female'),
  servicePriceProvider('Dr. Christopher Montgo Vander', undefined, 'male'),
  servicePriceProvider('Dr. Priya Sharma', 'https://images.unsplash.com/photo-1594824476967-48c8b964dc31?w=200&h=200&fit=crop&crop=face'),
]
...
const PROVIDERS_NOT_CONNECTED = [
  notConnectedProvider('Dr. Benjamin Lee', 'https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=200&h=200&fit=crop&crop=face'),
  notConnectedProvider('Dr. Sarah Chen', 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=200&h=200&fit=crop&crop=face'),
  notConnectedProvider('Dr. James Rodriguez', 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=200&h=200&fit=crop&crop=face'),
  notConnectedProvider('Dr. Emily Park', 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&h=200&fit=crop&crop=face'),
]
...
// ── Cost Box (above map) ─────────────────────────────────────
function CostBox({ scenario, onLearnMore, onConnect }: { scenario: ScenarioConfig; onLearnMore?: () => void; onConnect?: () => void }) {
...
export function Experiment2() {
  const scenarioId: ScenarioId = 'coinsurance-range'
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: SPACE_XXS }}>
            ...
            <Select
              ...
              renderTrigger={(selected) => {
                const opt = selected as { label?: string; iconLeft?: React.ReactNode } | undefined
                if (!opt) return <span style={{ flex: 1, color: TEXT_LIGHT, fontFamily: FONT, fontSize: fontSizes[14] }}>Network type</span>
                return (
                  <span style={{ flex: 1, display: 'flex', alignItems: 'center', gap: SPACE_XXS, fontFamily: FONT, fontSize: fontSizes[14] }}>
                    {opt.iconLeft}
                    {opt.label}
                  </span>
                )
