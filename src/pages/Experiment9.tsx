      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: SPACE_XXS }}>
          <p style={{
            ...
            fontSize: fontSizes[32], lineHeight: '38px', color: TEXT_DEFAULT, margin: 0,
          }}>
  ...
  if (cb.type === 'flat-cost') {
    return (
      <div style={cardStyle}>
        {headerSlot}
        <div>
          <p style={{ fontFamily: FONT_DISPLAY, fontWeight: W_MEDIUM, fontSize: fontSizes[32], lineHeight: '38px', color: TEXT_DEFAULT, margin: 0 }}>
    ...
    <div style={{ minHeight: '100vh', background: BG_WHITE }}>
          ...
          <div
            ...
            <div
              ...
              style={{
                ...
                background: activeSegment === 'service' ? BG_WHITE : hoveredSegment === 'service' && !activeSegment ? BG_SUBTLE : 'transparent',
                borderRadius: RADIUS_FULL,
            ...
            <div
              ...
              style={{
                ...
                cursor: 'pointer', position: 'relative',
                background: activeSegment === 'plan' ? BG_WHITE : hoveredSegment === 'plan' && !activeSegment ? BG_SUBTLE : 'transparent',
                borderRadius: RADIUS_FULL,
                transition: 'background 0.15s',
              }}
            >
            ...
            <div
              ...
              style={{
                flex: 1, padding: `${SPACE_XXS}px ${SPACE_M}px`,
                cursor: 'pointer', position: 'relative',
                background: activeSegment === 'network' ? BG_WHITE : hoveredSegment === 'network' && !activeSegment ? BG_SUBTLE : 'transparent',
                borderRadius: RADIUS_FULL,
                transition: 'background 0.15s',
              }}
            >
            ...
            <div
              ...
              style={{
                flex: 1, padding: `${SPACE_XXS}px ${SPACE_M}px`,
                cursor: 'pointer', position: 'relative',
                background: activeSegment === 'location' ? BG_WHITE : hoveredSegment === 'location' && !activeSegment ? BG_SUBTLE : 'transparent',
                borderRadius: RADIUS_FULL,
                transition: 'background 0.15s',
              }}
            >
      ...
      {showSidebar && <div style={{
        ...
        <div style={{
          ...
          {/* ── View Toggle (list / map) — right-aligned ── */}
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  width: 36, height: 32,
                  background: viewMode === 'list' ? BG_WHITE : 'transparent',
                  border: 'none', cursor: 'pointer',
                  borderRadius: viewMode === 'list' ? `${RADIUS_FULL}px 0 0 ${RADIUS_FULL}px` : 0,
              ...
              >
                <MapLine size="sm" color={viewMode === 'list' ? TEXT_DEFAULT : TEXT_LIGHT} style={{ display: 'none' }} />
                {/* List icon — 3 horizontal lines */}
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <rect x="1" y="3" width="14" height="2" rx="1" fill={viewMode === 'list' ? TEXT_DEFAULT : TEXT_LIGHT} />
                  <rect x="1" y="7" width="14" height="2" rx="1" fill={viewMode === 'list' ? TEXT_DEFAULT : TEXT_LIGHT} />
                  <rect x="1" y="11" width="14" height="2" rx="1" fill={viewMode === 'list' ? TEXT_DEFAULT : TEXT_LIGHT} />
                </svg>
              </button>
              {/* Map */}
              <button
                ...
                style={{
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  width: 36, height: 32,
                  background: viewMode === 'map' ? BG_WHITE : 'transparent',
                  border: 'none', cursor: 'pointer',
              ...
              >
                <MapLine size="sm" color={viewMode === 'map' ? TEXT_DEFAULT : TEXT_LIGHT} />
              </button>
            </div>
          </div>
        </div>
