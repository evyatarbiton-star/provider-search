...
import { Button, TextInput, Select, RadioButton, Toggle, ProviderCard, Modal, IconButton, StarRating, DatePicker } from 'glow-ds/components'
...
// ── Scenario System ──────────────────────────────────────────
type ScenarioId = 'copay-flat' | 'coinsurance-range' | 'copay-coinsurance' | 'meet-deductible' | 'meet-deductible-copay' | 'meet-deductible-higher-coins' | 'not-covered' | 'copay-subject-deductible' | 'fully-covered-after-ded' | 'fully-covered-before-ded' | 'fully-covered-oop-max' | 'not-connected' | 'deductible-na' | 'rbp' | 'indemnity'
...
const PROVIDERS_COPAY_FLAT = [
  { name: 'Dr. Sarah Chen', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.3 miles', address: '457 Broome St, New York, NY', rating: 4.8, reviewCount: 412, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Today, May 7' },
  { name: 'Dr. Christopher Montgo Vander', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.5 miles', address: '1250 Broadway, New York, NY', rating: 4.5, reviewCount: 320, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Tomorrow, May 8' },
  { name: 'Dr. Michael Torres', specialty: 'Ophthalmologist', providerType: 'male' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.8 miles', address: '30 E 40th St, New York, NY', rating: 4.2, reviewCount: 245, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Thu, May 9' },
  { name: 'Dr. Aisha Patel', specialty: 'Dermatologist', providerType: 'female' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.2 miles', address: '635 Madison Ave, New York, NY', rating: 3.9, reviewCount: 156, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Mon, May 12' },
  { name: 'Dr. David Kim', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.5 miles', address: '110 E 59th St, New York, NY', rating: 4.6, reviewCount: 178, cost: '$40', costLabel: 'Per visit', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Wed, May 14' },
]

// Fully covered — all $0
const PROVIDERS_ZERO_COST = [
  { name: 'Dr. Sarah Chen', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.3 miles', address: '457 Broome St, New York, NY', rating: 4.8, reviewCount: 412, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Today, May 7' },
  { name: 'Dr. Christopher Montgo Vander', specialty: 'Dermatologist', photoUrl: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=200&h=200&fit=crop&crop=face', networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.5 miles', address: '1250 Broadway, New York, NY', rating: 4.5, reviewCount: 320, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Tomorrow, May 8' },
  { name: 'Dr. Michael Torres', specialty: 'Ophthalmologist', providerType: 'male' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '0.8 miles', address: '30 E 40th St, New York, NY', rating: 4.2, reviewCount: 245, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Thu, May 9' },
  { name: 'Dr. Aisha Patel', specialty: 'Dermatologist', providerType: 'female' as const, networkTier: 'in-network' as const, networkLabel: 'In-Network', distance: '1.2 miles', address: '635 Madison Ave, New York, NY', rating: 3.9, reviewCount: 156, cost: '$0', costLabel: 'Est. out-of-pocket cost', nextAppointmentLabel: 'Next appointment', nextAppointmentDate: 'Mon, May 12' },
]
...
const PROVIDERS_SERVICE_PRICE = [
  servicePriceProvider('Dr. Sarah Chen', 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=200&h=200&fit=crop&crop=face'),
  servicePriceProvider('Dr. Christopher Montgo Vander', 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=200&h=200&fit=crop&crop=face'),
  servicePriceProvider('Dr. Michael Torres', undefined, 'male'),
  servicePriceProvider('Dr. Aisha Patel', undefined, 'female'),
...
const SCENARIOS: Record<ScenarioId, ScenarioConfig> = {
  'copay-flat': {
    ...
    modal: {
      ...
      explanation: 'Your plan has a fixed $40 copay for this service. You\'ll pay $40 per visit regardless of which in-network provider you choose. Most in-network providers in your area charge between $3,750–$4,750 for this service — the provider bills your insurance for the remaining balance.',
      afterInsurance: '$40',
  ...
  'copay-subject-deductible': {
    ...
    modal: {
      ...
      explanation: 'Your plan has a fixed $40 copay for this service, which applies after your deductible is met. Since you\'ve already met your $2,000 deductible, you\'ll pay $40 per visit. Most in-network providers in your area charge between $3,750–$4,750 — your insurance covers the rest.',
      afterInsurance: '$45',
      showGraph: false,
    },
    providers: PROVIDERS_COPAY_FLAT,
  ...
  'copay-coinsurance': {
    ...
    modal: {
      ...
      explanation: "Most in-network providers in your area charge between $3,750–$4,750 for this service. After your $40 copay and 40% coinsurance, most people's out-of-pocket cost falls between $1,240–$1,840.",
      beforeInsurance: '$3,750–$4,750',
      afterInsurance: '$1,240–$1,840',
      afterInsuranceColor: 'blue',
      costPercent: '40%',
      showGraph: true,
      graphRangeLow: '$240',
      graphRangeHigh: '$3,740',
    },
    providers: PROVIDERS_CONNECTED,
  },
  ...
  'meet-deductible': {
    id: 'meet-deductible',
    label: 'Meet ded → Coinsurance',
    description: 'Before: full price · After: 40% coinsurance',
    costBox: {
      type: 'range-graph',
    ...
    modal: {
      plan: 'Aetna PPO',
      network: 'In-network',
      deductible: '$1,200 remaining ($800/$2,000)',
      deductibleMet: false,
      coverageRows: [
        { label: 'Plan', value: 'Aetna PPO' },
        { label: 'Network', value: 'In-network' },
        { label: 'Deductible status', value: '$1,200 remaining ($800/$2,000)' },
        { label: 'Coverage (Before deductible)', value: '100% — you pay full price' },
        { label: 'Coverage (After deductible)', value: '40% coinsurance' },
      ],
      explanation: "Most in-network providers in your area charge between $3,750–$4,750 for this service. You have $1,200 remaining on your deductible. You'll pay full price until it's met. Once your deductible is met, your plan's 40% coinsurance kicks in. Your estimated out-of-pocket cost is between $800–$1,500.",
      beforeInsurance: '$3,750–$4,750',
      afterInsurance: '$800–$1,500',
      afterInsuranceColor: 'blue',
      costPercent: '40%',
      showGraph: true,
      graphRangeLow: '$200',
  ...
  'meet-deductible-copay': {
    id: 'meet-deductible-copay' as ScenarioId,
    label: 'Meet ded → Copay',
    description: 'Before: full price · After: $40 copay',
    costBox: {
      type: 'range-graph',
      typicalRange: '$540–$540',
      typicalLow: '$540',
      typicalHigh: '$540',
      rangeLow: '$500',
      rangeHigh: '$3,700',
    ...
    modal: {
      plan: 'Aetna PPO',
      network: 'In-network',
      deductible: '$500 remaining ($1,500/$2,000)',
      deductibleMet: false,
      coverageRows: [
        { label: 'Plan', value: 'Aetna PPO' },
        { label: 'Network', value: 'In-network' },
        { label: 'Deductible status', value: '$500 remaining ($1,500/$2,000)' },
        { label: 'Coverage (Before deductible)', value: '100% — you pay full price' },
        { label: 'Coverage (After deductible)', value: '$40 copay' },
      ],
      explanation: "Most in-network providers in your area charge between $3,750–$4,750 for this service. You have $500 remaining on your deductible. You'll pay full price until it's met. Once your deductible is met, you'll pay a $40 copay per visit. Your estimated out-of-pocket cost is between $540–$540.",
      beforeInsurance: '$3,750–$4,750',
      afterInsurance: '$540',
      afterInsuranceColor: 'blue',
      showGraph: false,
  ...
  'meet-deductible-higher-coins': {
    id: 'meet-deductible-higher-coins' as ScenarioId,
    label: 'Meet ded → Higher coinsurance before',
    description: 'Before: 50% coinsurance · After: 20% coinsurance',
    costBox: {
      type: 'range-graph',
      typicalRange: '$600–$950',
      typicalLow: '$600',
      typicalHigh: '$950',
      rangeLow: '$600',
      rangeHigh: '$3,700',
    ...
    modal: {
      ...
      coverageRows: [
        ...
        { label: 'Network', value: 'In-network' },
        { label: 'Deductible status', value: '$1,200 remaining ($800/$2,000)' },
        { label: 'Coverage (Before deductible)', value: '50% coinsurance' },
        { label: 'Coverage (After deductible)', value: '20% coinsurance' },
      ],
      explanation: "Most in-network providers in your area charge between $3,750–$4,750 for this service. You have $1,200 remaining on your deductible. You'll pay 50% of the service cost until it's met. Once your deductible is met, your plan's 20% coinsurance kicks in. Your estimated out-of-pocket cost is between $600–$950.",
      beforeInsurance: '$3,750–$4,750',
      afterInsurance: '$600–$950',
      afterInsuranceColor: 'blue',
      costPercent: '20%',
      showGraph: true,
      graphRangeLow: '$200',
  ...
  'fully-covered-after-ded': {
    ...
    modal: {
      ...
      explanation: "Most in-network providers in your area charge between $3,750–$4,750 for this service. Since you've met your $2,000 deductible, your plan covers this service at 100% — your out-of-pocket cost is $0.",
      beforeInsurance: '$3,750–$4,750',
      afterInsurance: '$0',
  ...
  'fully-covered-before-ded': {
    ...
    modal: {
      ...
      explanation: "Most in-network providers in your area charge between $3,750–$4,750 for this service. Your plan covers this service at 100% regardless of deductible status — your out-of-pocket cost is $0.",
      beforeInsurance: '$3,750–$4,750',
      afterInsurance: '$0',
      afterInsuranceColor: 'green',
      showGraph: false,
  ...
  'fully-covered-oop-max': {
    ...
    modal: {
      ...
      explanation: "Most in-network providers in your area charge between $3,750–$4,750 for this service. Since you've reached your $6,500 out-of-pocket maximum, your plan covers all remaining costs at 100% — your out-of-pocket cost is $0.",
      beforeInsurance: '$3,750–$4,750',
      afterInsurance: '$0',
      afterInsuranceColor: 'green',
      showGraph: false,
...
export function ProviderSearchResults() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG_WHITE }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ marginBottom: SPACE_L }}>
            ...
            {/* Mobile action buttons: Map view + All filters */}
            {!showSidebar && (
              <div style={{
            ...
            {/* CostBox for mobile (when sidebar is hidden) */}
            {!showSidebar && (
              <div style={{ marginTop: SPACE_S }}>
                {isLoading ? <CostBoxSkeleton /> : <CostBox scenario={scenario} onLearnMore={() => setShowCostModal(true)} onConnect={() => setShowConnectModal(true)} />}
              </div>
      ...
      <ScenarioSwitcher current={scenarioId} onChange={setScenarioId} />
